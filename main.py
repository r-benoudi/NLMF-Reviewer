...
class ComprehensiveExperimentalFramework:
    ...
    def _plot_convergence_analysis(self, all_results):
        ...
        noise_levels = [10, 20, 30]  # Subset for clarity
...
def main_comprehensive_analysis():
    ...
    results = framework.run_comprehensive_experiments(
        ...
        generation_counts=[50, 10],     # Can be expanded to [25, 50, 100]
        noise_levels=[10, 20, 30],
        num_runs=2                  # Can be increased to 5 or 10 for better statistics
    )
